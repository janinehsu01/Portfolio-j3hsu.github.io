...
var die1, die2, dieSum, balance, banner, outcome, die1Name, die2Name, numRolls, balanceStatus; // define variables
...
function whoWon() {
  ...
  balanceStatus = "Your total balance is: " + balance + " dollars";
  document.querySelector("h3").innerHTML = banner + "<br>" + outcome;
  
  document.querySelector(".balance").innerHTML = balanceStatus;
